...
chat = GigaChat(credentials='Yzk1ODc3NTEtMGRlMy00OWUxLTkzMzEtMzc1ZjRjN2UzYzFkOmU3MTQwNWY2LWNiZjYtNGNlNi1hYTc5LWUyMDM5YjlhODIxZA==', verify_ssl_certs=False)

messages = [
    SystemMessage(
        content="Ты бот-механик, который помогает пользователю решить его проблемы с технологическим оборудованием."
    )
]
