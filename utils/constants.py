...
MANUAL = (
    ...
    'донесение об отказе по форме ОД-01, а также на почту всех специалистов по ГПА, зам.начальника '
    ...
    '<b>(технологическую карту)</b> по расследованию отказа с распределением по направлениям '
    ...
    '4. <u>Ежедневно</u> направлять информацию о выполненных работах в соответствии с технологической картой, выявленных неисправностях '
